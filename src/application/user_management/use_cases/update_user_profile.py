...
from src.application.user_management.dtos.user_dto import UpdateUserProfileDTO, UserDTO
...
class UpdateUserProfileUseCase:
    ...
    async def execute(self, dto: UpdateUserProfileDTO) -> UserDTO:
        """Execute use case.
        
        Args:
            dto: Update user profile DTO
        ...
        # Update profile
        telegram_username = TelegramUsername(dto.telegram_username) if dto.telegram_username is not None else None
        user.update_profile(
