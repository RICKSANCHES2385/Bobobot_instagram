...
from ..dtos import RenewSubscriptionCommand, SubscriptionDTO
...
class RenewSubscriptionUseCase(UseCase[RenewSubscriptionCommand, SubscriptionDTO]):
    ...
    async def execute(self, command: RenewSubscriptionCommand) -> SubscriptionDTO:
        """Execute use case.
        
        Args:
            command: Renew subscription command.
        ...
        # Renew subscription
        subscription.renew(days=command.days)
